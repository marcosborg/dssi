...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Product::with(['manufacturer', 'solution', 'category'])->select(sprintf('%s.*', (new Product)->table));
            ...
            $table->addColumn('solution_name_pt', function ($row) {
                return $row->solution ? $row->solution->name_pt : '';
            });
            ...
            $table->rawColumns(['actions', 'placeholder', 'manufacturer', 'solution', 'category', 'image']);
    ...
    public function create()
    {
        ...
        $solutions = Solution::pluck('name_pt', 'id')->prepend(trans('global.pleaseSelect'), '');

        $categories = Category::pluck('name_pt', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('admin.products.create', compact('categories', 'manufacturers', 'solutions'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        $product->load('manufacturer', 'solution', 'category');

        return view('admin.products.edit', compact('categories', 'manufacturers', 'product', 'solutions'));
    }
