...
class CompanyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Company::with(['country', 'user'])->select(sprintf('%s.*', (new Company)->table));
            ...
            $table->editColumn('type', function ($row) {
                return $row->type ? Company::TYPE_RADIO[$row->type] : '';
            });
        ...
        return view('admin.companies.index', compact('countries', 'users'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.companies.create', compact('countries', 'users'));
    }
    ...
    public function edit(Company $company)
    {
        ...
        $company->load('country', 'user');

        return view('admin.companies.edit', compact('company', 'countries', 'users'));
    }
