                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.manufacturers.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('text_pt') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="text_pt" id="text_pt">{!! old('text_pt') !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('text_en') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="text_en" id="text_en">{!! old('text_en') !!}</textarea>
