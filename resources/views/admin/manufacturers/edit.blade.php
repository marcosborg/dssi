    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.manufacturers.update", [$manufacturer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}" type="text" name="url" id="url" value="{{ old('url', $manufacturer->url) }}">
                @if($errors->has('url'))
                    <div class="invalid-feedback">
                        {{ $errors->first('url') }}
                    </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('pt') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="pt" id="pt" value="1" {{ $manufacturer->pt || old('pt', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('mz') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="mz" id="mz" value="1" {{ $manufacturer->mz || old('mz', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('ao') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="ao" id="ao" value="1" {{ $manufacturer->ao || old('ao', 0) === 1 ? 'checked' : '' }}>
