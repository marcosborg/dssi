        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.sopho.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.sophos.update", [$sopho->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('product') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="product_id" id="product_id" required>
                                @foreach($products as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('product_id') ? old('product_id') : $sopho->product->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('family') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="family" id="family" value="{{ old('family', $sopho->family) }}">
                        ...
                        <div class="form-group {{ $errors->has('type') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="type" id="type" value="{{ old('type', $sopho->type) }}">
                            @if($errors->has('type'))
                        ...
                        <div class="form-group {{ $errors->has('term') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="term" id="term" value="{{ old('term', $sopho->term) }}" step="1">
                            @if($errors->has('term'))
                        ...
                        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="description" id="description">{{ old('description', $sopho->description) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('min') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="min" id="min" value="{{ old('min', $sopho->min) }}" step="1">
                            @if($errors->has('min'))
                        ...
                        <div class="form-group {{ $errors->has('max') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="max" id="max" value="{{ old('max', $sopho->max) }}" step="1">
                            @if($errors->has('max'))
                        ...
                        <div class="form-group {{ $errors->has('price_partner_met') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="price_partner_met" id="price_partner_met" value="{{ old('price_partner_met', $sopho->price_partner_met) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('pvp_met') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="pvp_met" id="pvp_met" value="{{ old('pvp_met', $sopho->pvp_met) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('price_partner_kwa') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="price_partner_kwa" id="price_partner_kwa" value="{{ old('price_partner_kwa', $sopho->price_partner_kwa) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('pvp_kwa') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="pvp_kwa" id="pvp_kwa" value="{{ old('pvp_kwa', $sopho->pvp_kwa) }}" step="0.01">
