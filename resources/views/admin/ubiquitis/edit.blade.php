    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.ubiquitis.update", [$ubiquiti->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_number') ? 'is-invalid' : '' }}" type="text" name="product_number" id="product_number" value="{{ old('product_number', $ubiquiti->product_number) }}">
