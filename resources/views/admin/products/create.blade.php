    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('solution') ? 'is-invalid' : '' }}" name="solution_id" id="solution_id" required>
                    @foreach($solutions as $id => $entry)
                        <option value="{{ $id }}" {{ old('solution_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('questions') ? 'is-invalid' : '' }}" type="number" name="questions" id="questions" value="{{ old('questions', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('question_1_pt') ? 'is-invalid' : '' }}" type="text" name="question_1_pt" id="question_1_pt" value="{{ old('question_1_pt', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('question_1_en') ? 'is-invalid' : '' }}" type="text" name="question_1_en" id="question_1_en" value="{{ old('question_1_en', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('question_2_pt') ? 'is-invalid' : '' }}" type="text" name="question_2_pt" id="question_2_pt" value="{{ old('question_2_pt', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('question_2_en') ? 'is-invalid' : '' }}" type="text" name="question_2_en" id="question_2_en" value="{{ old('question_2_en', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('question_3_pt') ? 'is-invalid' : '' }}" type="text" name="question_3_pt" id="question_3_pt" value="{{ old('question_3_pt', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('question_3_en') ? 'is-invalid' : '' }}" type="text" name="question_3_en" id="question_3_en" value="{{ old('question_3_en', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('question_4_pt') ? 'is-invalid' : '' }}" type="text" name="question_4_pt" id="question_4_pt" value="{{ old('question_4_pt', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('question_4_en') ? 'is-invalid' : '' }}" type="text" name="question_4_en" id="question_4_en" value="{{ old('question_4_en', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('question_5_pt') ? 'is-invalid' : '' }}" type="text" name="question_5_pt" id="question_5_pt" value="{{ old('question_5_pt', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('question_5_en') ? 'is-invalid' : '' }}" type="text" name="question_5_en" id="question_5_en" value="{{ old('question_5_en', '') }}">
