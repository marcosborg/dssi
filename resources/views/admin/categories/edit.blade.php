                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.categories.update", [$category->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('name_pt') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name_pt" id="name_pt" value="{{ old('name_pt', $category->name_pt) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('name_en') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name_en" id="name_en" value="{{ old('name_en', $category->name_en) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('description_pt') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="description_pt" id="description_pt">{!! old('description_pt', $category->description_pt) !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('description_en') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="description_en" id="description_en">{!! old('description_en', $category->description_en) !!}</textarea>
