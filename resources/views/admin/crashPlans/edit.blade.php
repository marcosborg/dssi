...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.crash-plans.update", [$crashPlan->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="part_number">{{ trans('cruds.crashPlan.fields.part_number') }}</label>
                <input class="form-control {{ $errors->has('part_number') ? 'is-invalid' : '' }}" type="text" name="part_number" id="part_number" value="{{ old('part_number', $crashPlan->part_number) }}">
                @if($errors->has('part_number'))
                    <div class="invalid-feedback">
                        {{ $errors->first('part_number') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.crashPlan.fields.part_number_helper') }}</span>
            </div>
            <div class="form-group">
